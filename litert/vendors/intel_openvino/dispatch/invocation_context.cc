...
// This class is copied from the OpenVINO codebase. It wraps a pre-allocated
// memory buffer to provide a std::streambuf interface, enabling zero-copy
// stream reading.

// TODO: Remove SharedStreamBuffer once OpenVINO provides a public equivalent.
...
LiteRtDispatchInvocationContextT::Create(
  ...
  SharedStreamBuffer membuf(
      static_cast<const char*>(exec_bytecode_ptr), exec_bytecode_size);
